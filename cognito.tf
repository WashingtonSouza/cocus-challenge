...
resource "aws_cognito_resource_server" "this" {
  ...
  scope {
    scope_name        = "read_trip"
    scope_description = "Read trips"
  }

  scope {
    scope_name        = "create_trip"
    scope_description = "Create trips"
  }

  scope {
    scope_name        = "delete_trip"
    scope_description = "Delete trips"
  }
